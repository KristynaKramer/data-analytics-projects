...
def load_data():
    ...
    co2 = pd.read_excel(
        '02-Kaya-decomposition/IEA_EDGAR_CO2_1970_2024.xlsx',
    ...
    population = pd.read_csv(
        '02-Kaya-decomposition/population.csv',
        skiprows = 4
    )
    ...
    gdp_population = pd.read_csv(
        '02-Kaya-decomposition/GDP_PCAP.csv',
        skiprows = 4
    )
    ...
    energy_gdp = pd.read_csv(
        '02-Kaya-decomposition/Energy_perGDP.csv',
        skiprows = 4
    )
    ...
    co2_energy_long = pd.read_csv(
        '02-Kaya-decomposition/co2-per-unit-energy.csv'
    )
